...
var NavbarActions = (function () {
  function NavbarActions() {
    ...
    this.generateActions('getDribbleSuccess');
  }
  ...
  _createClass(NavbarActions, [{
    ...
    value: function findImages() {
      ...
      $.ajax({
        ...
        _this.actions.getDribbleSuccess(data);
      }).fail(function (data) {
        console.log(data);
      });
    }
...
},{"../actions/HomeActions":1,"../stores/HomeStore":12,"../stores/NavbarStore":14,"react":"react","react-router":"react-router","underscore":"underscore"}],8:[function(require,module,exports){
'use strict';
...
var DribbleImage = (function (_React$Component) {
  _inherits(DribbleImage, _React$Component);

  function DribbleImage(props) {
    _classCallCheck(this, DribbleImage);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DribbleImage).call(this, props));

    _this.state = _ImageTagStore2.default.getState();
    return _this;
  }

  _createClass(DribbleImage, [{
    key: '_handleClick',
    value: function _handleClick(html_url) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'dribble-container' },
        _react2.default.createElement(
          'div',
          { className: 'dribble-image-container', onClick: this._handleClick.bind(null, attr.html_url) },
          _react2.default.createElement(
            'img',
            { className: 'dribble-image', src: attr.images.normal },
            _react2.default.createElement(
              'h4',
              { className: 'dribble-likes' },
              attr.likes_count,
              ' Likes'
            )
          ),
          _react2.default.createElement(
            'div',
            { className: 'dribble-caption' },
            _react2.default.createElement('img', { className: 'dribble-profile-image', src: attr.user.avatar_url }),
            _react2.default.createElement(
              'div',
              { className: 'dribble-caption-text' },
              _react2.default.createElement(
                'h4',
                null,
                attr.title
...
var Navbar = (function (_React$Component) {
  ...
  _createClass(Navbar, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _NavbarActions2.default.findImages();
      _NavbarStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.state.dribbleImages.map(function (dribbleImg) {
          return _react2.default.createElement(_ImageTag2.default, { props: dribbleImg });
        })
      );
    }
  }]);
...
},{"../actions/NavbarActions":3,"../stores/NavbarStore":14,"./ImageTag":8,"react":"react","react-router":"react-router"}],10:[function(require,module,exports){
'use strict';
...
var NavbarStore = (function () {
  ...
  _createClass(NavbarStore, [{
    key: 'onGetDribbleSuccess',
    value: function onGetDribbleSuccess(data) {
